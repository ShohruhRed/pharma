...
from . import (routes_ml, routes_sanfis, routers_batches, routes_stages, routes_predictions,
               routers_stage_data, routers_stage_predictions)# + routes_batches, routes_stages если добавишь
